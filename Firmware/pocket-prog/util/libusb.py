...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_libusb', [dirname(__file__)])
        except ImportError:
            import _libusb
            return _libusb
        if fp is not None:
            try:
                _mod = imp.load_module('_libusb', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _libusb = swig_import_helper()
...
def usb_control_in(*args):
  return _libusb.usb_control_in(*args)
usb_control_in = _libusb.usb_control_in

def usb_control_out(*args):
  return _libusb.usb_control_out(*args)
usb_control_out = _libusb.usb_control_out

def usb_string(*args):
  return _libusb.usb_string(*args)
...
class usb_descriptor_header(_object):
    ...
    def __init__(self): 
        this = _libusb.new_usb_descriptor_header()
...
class usb_string_descriptor(_object):
    ...
    def __init__(self): 
        this = _libusb.new_usb_string_descriptor()
        try: self.this.append(this)
        except: self.this = this
...
class usb_hid_descriptor(_object):
    ...
    def __init__(self): 
        this = _libusb.new_usb_hid_descriptor()
        try: self.this.append(this)
        except: self.this = this
...
class usb_endpoint_descriptor(_object):
    ...
    def __init__(self): 
        this = _libusb.new_usb_endpoint_descriptor()
        try: self.this.append(this)
        except: self.this = this
...
class usb_interface_descriptor(_object):
    ...
    def __init__(self): 
        this = _libusb.new_usb_interface_descriptor()
        try: self.this.append(this)
        except: self.this = this
...
class usb_interface(_object):
    ...
    def __init__(self): 
        this = _libusb.new_usb_interface()
        try: self.this.append(this)
        except: self.this = this
...
class usb_config_descriptor(_object):
    ...
    def __init__(self): 
        this = _libusb.new_usb_config_descriptor()
        try: self.this.append(this)
        except: self.this = this
...
class usb_device_descriptor(_object):
    ...
    def __init__(self): 
        this = _libusb.new_usb_device_descriptor()
        try: self.this.append(this)
        except: self.this = this
...
class usb_ctrl_setup(_object):
    ...
    def __init__(self): 
        this = _libusb.new_usb_ctrl_setup()
        try: self.this.append(this)
        except: self.this = this
...
LIBUSB_PATH_MAX = _libusb.LIBUSB_PATH_MAX
